...
const InfoCard: React.FC<InfoCardProps> = ({
  ...
  return (
    <div
      className="w-full bg-blue-50 rounded-[30px] transition hover:bg-blue-100 cursor-pointer overflow-hidden"
      onClick={onClick}
    >
      {/* Header */}
    ...
    <section className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row justify-start items-start gap-10 px-4 py-12">
      ...
      <div className="flex-1 flex flex-col justify-start items-start gap-6">
        ...
        <p className="text-xl sm:text-2xl font-semibold text-neutral-900 leading-7 max-w-[600px]">
          Complete hassle-free experience to all customers with best prices and
          offers!!
        </p>
        <div className="flex flex-col gap-4 max-w-[600px]">
          <p className="text-base sm:text-base font-normal f text-zinc-600 leading-relaxed">
            ...
            for thousands of happy customers. We’re passionate about delivering
            quality products with lightning-fast service, secure payments, and
            dedicated support.
          </p>
