...
// import PaymentMethods from "../accounts/AccountsMethods";
        ...
        <div className="w-full flex flex-col md:col-span-2 gap-8">
          ...
          <div className="p-6 bg-sky-400/5 rounded-2xl shadow-[2px_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-[2px] flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                {/* Free Shipping */}
                <label className="flex-1 flex justify-between items-center p-6 bg-white rounded-full border border-gray-300 cursor-pointer hover:border-[#26ADDF]">
                  <div className="flex gap-4 items-center">
                    {/* Custom Radio */}
                    <input
                      type="radio"
                ...
                {/* Express Shipping */}
                <label className="flex-1 flex justify-between items-center p-6 bg-white rounded-full border cursor-pointer hover:border-[#26ADDF] border-gray-300">
                  <div className="flex gap-4 items-center">
                    {/* Custom Radio */}
                    <input
                      type="radio"
