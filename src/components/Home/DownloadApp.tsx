...
const DownloadApp: React.FC = () => {
  return (
    <div className="w-full px-4 lg:px-32 my-12 sm:my-20">
      <section
        className="max-w-8xl mx-auto rounded-[30px] sm:rounded-[50px] shadow-lg bg-[#041A65] flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-10 p-6 sm:p-10"
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-center w-full lg:w-auto">
          <Image
            ...
            height={500}
            alt="phone"
            className="w-64 sm:w-80 lg:w-full h-auto object-contain"
          />
        </div>

        {/* Right side content */}
        <div className="flex-1 flex flex-col gap-6 sm:gap-10 text-white text-center lg:text-left">
          {/* Heading & Description */}
          <div>
