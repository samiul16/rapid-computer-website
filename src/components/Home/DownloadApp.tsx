...
const DownloadApp: React.FC = () => {
  return (
    <div className="w-full px-4 lg:px-32 my-20">
      <section
        className="max-w-8xl mx-auto rounded-[50px] shadow-lg bg-[#041A65] flex flex-col lg:flex-row items-center justify-between gap-10 p-10"
        style={{
